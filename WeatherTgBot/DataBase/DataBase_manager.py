...
class DataBase:
    ...
    def search_temperature(self, search_city):
        url = 'https://yandex.ru/pogoda/'
        dict_city = {'москва': 'moscow', 'аарвр': 'кеуке'}
        url = url + dict_city.get('москва')

        content_div = soup.find('span', class_='temp__value temp__value_with-unit').text
